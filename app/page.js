    ...
    <HeaderRegionDiv>
      ...
      <DetailsDiv>
        ...
        <Detail
          information={
          <div>
          <p>Currently, I am working as an R&D engineer in <Link href="https://imec.be" target="_blank">imec</Link>, <Link href="https://www.imec-int.com/en/expertise/compute-system-architecture" target="_blank">Compute System Architecture (CSA)</Link>. department</p>
          <p>
        ...
        <Detail
          information={
            <div>During my undergraduate studies, I've mainly focused on fluid mechanics, gas dynamics, computational fluid dynamics, finite element analysis, and mesh generation.
            </div>
          }
        >
        </Detail>
        ...
        <Detail
          information={
            <div>I enjoy, lifting, boxing, running, cycling, playing tennis, and tinkering with embedded programming. Time to time I like to DJ as well.</div>
          }
        >
        </Detail>
      </DetailsDiv>
